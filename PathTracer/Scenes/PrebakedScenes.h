...
void white_cornell_box(PathTracer* im)
{
    im->set_fov(60.0f);
    ///Luces puntuales
    shared_ptr<PointLight> lp_central(new PointLight{ Color{ 2.0f, 2.0f, 2.0f }, Vector3{ 60.0f, 17.5f, 0.0f } });              //POINT LIGHT
    shared_ptr<PointLight> lp_amarilla(new PointLight{ Color{ 3.0f, 3.0f, 1.0f }, Vector3{ 60.0f, -15.0f, 0.0f } });              //POINT LIGHT
    ...
    shared_ptr<Texture> barrel_cyl_tex = read_tex_from_file("../../../../PathTracer/Textures/barrel.ppm", -M_PI, M_PI, 0.0f, 16.0f);
    shared_ptr<Texture> barrel_quad_tex = read_tex_from_file("../../../../PathTracer/Textures/barrel.ppm", 0, 22.0f, 0.0f, 32.0f);
    ...
    shared_ptr<Material> mat_Sphere1_b = create_specular_material(); //Color(20, 20, 20)
    shared_ptr<Material> mat_techo_emisor = create_emitting_material(Color{ 1.0f, 1.0f, 1.0f });                        //AREA LIGHT
    shared_ptr<Material> mat_tierra_esf = create_diffuse_material(tierra_tex_esf);
    shared_ptr<Material> mat_techo_oscuro = create_diffuse_material(Color{ 0.294f, 0.294f, 0.294f });
    shared_ptr<Material> mat_amarillo_dif = create_diffuse_material(Color{ 0.784f, 0.705f, 0.078f });
    shared_ptr<Material> mat_Sphere3 = create_dielectric_material(cristal_1);
    shared_ptr<Material> mat_Cylinder = create_dielectric_material(cristal_1);
    ...
    shared_ptr<Material> mat_chicle_fresnel = create_plastic_material_fresnel(tierra_tex_esf);
    shared_ptr<Material> mat_chicle_semidif = create_plastic_material(Color{ 1.0f, 0.450f, 0.862f }, Color{ 0.039f, 0.039f, 0.039f });
    shared_ptr<Material> mat_chicle_dif = create_diffuse_material(Color{ 1.0f, 0.450f, 0.862f });
    shared_ptr<Material> mat_chicle_reflejo_azul = create_plastic_material(Color{ 1.0f, 0.450f, 0.862f } / 2.0, Color{ 0.784f, 0.784f, 0.004f } / 2.0f);
    shared_ptr<Material> mat_barrel_quad = create_plastic_material_fresnel(barrel_quad_tex);
    shared_ptr<Material> mat_barrel_cyl = create_plastic_material_fresnel(barrel_cyl_tex);
    ...
    shared_ptr<Shape> techo_cerca(new Quad(Vector3{ 15, 25, -10 }, Vector3{ 15, 25, 10 }, Vector3{ 0, 25, -10 }, Vector3{ 0, 25, 10 }, mat_pared_tex));
    shared_ptr<Shape> techo_fondo(new Quad(Vector3{ 85, 25, -10 }, Vector3{ 85, 25, 10 }, Vector3{ 70, 25, -10 }, Vector3{ 70, 25, 10 }, mat_pared_tex));
    shared_ptr<Shape> barrel(new Quad(Vector3{ 65, 7, -12 }, Vector3{ 65, 7, 11 }, Vector3{ 65, -25, -12 }, Vector3{ 65, -25, 11 }, mat_barrel_quad, true));
    //Spheres
    shared_ptr<Shape> esf1(new Sphere(Vector3{ 58, -18, -17 }, 7.0f, mat_tierra_esf));              //dif tex
    shared_ptr<Shape> esf2(new Sphere(Vector3{ 65, -18, -8 }, 7.0f, mat_Sphere3));                  //dielec 
    shared_ptr<Shape> esf3(new Sphere(Vector3{ 65, -18, 8 }, 7.0f, mat_chicle_reflejo_azul));       //plastic
    shared_ptr<Shape> esf4(new Sphere(Vector3{ 58, -18, 17 }, 7.0f, mat_Sphere1_b));                //spec
    //shared_ptr<Shape> esf5(new Sphere(Vector3{ 60, -5, 10.0 }, 9.0f, mat_tierra_emisora));
    //Cylinder de prueba
    shared_ptr<Shape> cil_finito(new Cylinder(Vector3{ 65, -25, 0 }, Vector3{ 0, 1, 0 }, 22.0f / M_PI, 16.0f, mat_barrel_cyl));
    shared_ptr<Shape> cil_finito2(new Cylinder(Vector3{ 65, -25, 0 }, Vector3{ 0, 1, 0 }, (22.0f / M_PI) - 1.0f, 16.01f, mat_pared_der));

    shared_ptr<Shape> cil1(new Cylinder( Vector3{ 65, -25, 0 }, Vector3{ 0.0f, 1.0f, 0.0f }, 16.0f, 6.0f, mat_Sphere3 ) );
    shared_ptr<Shape> cil2(new Cylinder{ Vector3{ 65, -25.0, 0.5 }, Vector3{ 0.5f, 1.0f, 1.0f}, 5.0, 25.0f, mat_Sphere1 });
...
void doom_cornell_box(PathTracer* im)
{
    ...
    shared_ptr<Texture> barrel_tex = read_tex_from_file("../../../../PathTracer/Textures/barrel.ppm", 0.0f, 22.0f, 0.0f, 32.0f);
